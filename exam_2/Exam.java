...
public class Exam {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("The number of character for firstname is: " + stringSize1);
        System.out.print("Enter your surname: ");
        String surName = scan.next();
        int stringsize2 = surName.length();
        System.out.println("The number of character for surname is: " + stringsize2);
        int sum = stringSize1 + stringsize2;
        ...
        System.out.print("Largest number is " + firstNumber);
        else if(secondNumber > thirdNumber)
        System.out.print("Largest number is " + secondNumber);
        else
        ...
        if(studentEmailAddress.contains( "alladoa@students.national-u.edu.ph"))
        System.out.println("valid");
        else
        System.out.println("invalid");
        }
